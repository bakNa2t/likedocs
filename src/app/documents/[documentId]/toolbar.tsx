  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex flex-col items-center justify-center h-7 min-w-7 shrink-0 rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
...
const FontSizeButton = () => {
  ...
  return (
    <div className="flex items-center gap-x-0.5">
      <button
        className="flex items-center justify-center h-7 w-7 shrink-0 rounded-sm hover:bg-neutral-200/80"
        onClick={decrement}
      >
...
const HeadingLevelButton = () => {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center justify-center h-7 min-w-7 shrink-0 rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm">
